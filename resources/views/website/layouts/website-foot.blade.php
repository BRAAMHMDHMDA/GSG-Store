...
{{--<div class="newsletter-popup mfp-hide" id="newsletter-popup" style="background-image: url({{asset('website/images/newsletter-popup.jpg')}})">--}}
...
{{--        <p class="text-grey">Subscribe to the Riode eCommerce newsletter to receive timely updates from your favorite products.--}}
{{--        </p>--}}
...
<script src="{{ asset('website/vendor/parallax/parallax.min.js') }}"></script>
<script src="{{ asset('website/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
<script src="{{ asset('website/vendor/elevatezoom/jquery.elevatezoom.min.js') }}"></script>
...
<script src="{{ asset('website/vendor/sticky/sticky.min.js') }}"></script>
<script src="{{ asset('website/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
<script src="{{ asset('website/vendor/elevatezoom/jquery.elevatezoom.min.js') }}"></script>
