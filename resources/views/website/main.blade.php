...
{{--                        </div>--}}
            ...
            {{--End ps-section__content--}}
        </div>
        {{--End ps-container--}}
    </div>
    {{--End section--features-product--}}
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                                ...
                                <div class="ps-hotspot__content">
                                    <p class="heading">JUMP TO HEADER</p>
                                    <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                                </div></a><img src="{{ asset('front/images/hot-deal.png') }}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ps-section__content">
                <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/1.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                ...
                                <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ asset('front/images/shoe/6.jpg') }}" alt=""><a class="ps-shoe__overlay" href="products/show.blade.php"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="{{ asset('front/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('front/images/shoe/5.jpg') }}" alt=""></div>
