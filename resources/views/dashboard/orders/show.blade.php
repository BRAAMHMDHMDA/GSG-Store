...
@section('content_title', 'Order Preview')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('orders.index')}}">Orders</a></li>
    <li class="breadcrumb-item active">Order#{{$order->number}}</li>
@endsection
        ...
        <div class="row invoice-preview">
            ...
            <div class="col-xl-9 col-md-8 col-12">
                <div class="card invoice-preview-card">
                    <div class="card-body invoice-padding pb-0  p-20">
                        <!-- Header starts -->
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            ...
                            <div class="mt-md-0 mt-2">
                                ...
                                <div class="invoice-date-wrapper">
                                    ...
                                    <p class="invoice-date">{{$order->created_at->format('g:m a')}}</p>
                                </div>
                                <div class="invoice-date-wrapper">
                    ...
                    <div class="card-body invoice-padding pt-0">
                        <div class="row invoice-spacing">
                            <div class="col-xl-8 p-0">
                                ...
                                <h6 class="mb-25">{{$order->billing_name}}</h6>
                                <p class="card-text mb-25">{{$order->billing_address}}</p>
                                <p class="card-text mb-25">{{$order->billing_country}}</p>
                                <p class="card-text mb-25">{{$order->billing_phone}}</p>
                                <p class="card-text mb-0">{{$order->billing_email}}</p>
                            </div>
...
{{--                                    </tr>--}}
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="py-1">Name Of Product</th>
                                ...
                                <tbody>
                                    @foreach($order->items as $item)
                                        <tr @if($loop->last) class="border-bottom-warning" @endif>
                                            <td class="py-1">
...
{{--                            </tr>--}}
                    ...
                    <div class="card-body invoice-padding pb-0" style="margin-top: 15px">
                        <div class="row invoice-sales-total-wrapper">
                            <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                <p class="card-text mb-0">
                                    <span class="font-weight-bold">Shipping To:</span> <span class="ml-75">{{$order->shipping_name}}, {{$order->shipping_email}}</span>
                                </p>
                            </div>
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    ...
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount">${{$order->discount}}</b></p>
                                    </div>
                                    <div class="invoice-total-item">
