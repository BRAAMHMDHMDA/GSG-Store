    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_files/app-assets/vendors/css/extensions/nouislider.min.css') }}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_files/src/scss/plugins/forms/select2/_select2.scss') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_files/app-assets/vendors/css/forms/select/select2.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_files/app-assets/css/plugins/extensions/ext-component-sliders.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_files/app-assets/css/pages/app-ecommerce.css') }}">
